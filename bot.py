...
async def publish_welcome_post(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "📂 <b>Даём все документы</b> — можно списать в расходы и экономить на налогах\n\n"
        ...
        "#жбанкод #telegramбот #ботподключ #заявкивботе #ботдлябизнеса "
        "#лидогенерация #автоматизация #чатбот #онлайнсотрудник #ботдлялогистики"
    )
