...
async def publish_welcome_post(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "🤖 Создаём Telegram-ботов, которые делают всю скучную работу за вас:\n"
        "заявки, оплаты, воронки, документы и даже переписку с клиентами.\n\n"
        "🔹 Заявки — сразу в аккуратную таблицу\n"
        "🔹 Оплаты — прямо в Telegram, без сайтов и программистов\n"
        "🔹 Воронки, автоответы, автопостинг — всё работает само\n"
        "🔹 Подходит для агентств, команд, логистов, ВЭД, трафика и не только\n\n"
        "📂 <b>Даём все документы</b> — можно списать в расходы и снизить налоги\n\n"
        "📚 В этом канале — кейсы, шаблоны и автоматизации, которые реально приносят результат\n\n"
